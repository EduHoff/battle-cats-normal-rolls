...
pub async fn home_page(
    ...
    let selected_last = params.last.unwrap_or_default();
    ...
    let rows = build_tracker_rows(current_seed, current_count, selected_banner, &selected_last);
    ...
    context.insert("selected_last", &selected_last);
